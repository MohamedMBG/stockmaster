    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('role', models.CharField(choices=[('ADMIN', 'Administrator'), ('SUPERVISOR', 'Supervisor'), ('CLIENT', 'Client'), ('SUPPLIER', 'Supplier'), ('VIRTUAL_ASSISTANT', 'Virtual Assistant')], default='CLIENT', max_length=20)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.BigAutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('alert_type', models.CharField(choices=[('LOW_STOCK', 'Low Stock'), ('OUT_OF_STOCK', 'Out of Stock'), ('PRICE_CHANGE', 'Price Change'), ('SYSTEM', 'System Alert')], max_length=15)),
